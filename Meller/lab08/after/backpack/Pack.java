...
import matrixesPack.ArithmeticException;
...
public class Pack {
    ...
    public void solvePack(int tcount) throws InterruptedException{
        if(tcount > getCountOfItems() || tcount <= 0){throw new ArithmeticException("Incorrect amount of Threads!"); }

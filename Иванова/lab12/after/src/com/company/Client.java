...
class ClientSomthing {
    ...
    private boolean isAdmin; //роль клиента - админ он или нет;
    ...
    private void pressNickname() {
        ...
        try {
            ...
            do {
                ...
                {
                    res = false;
                    System.out.println("Данное имя уже занято");
                }
            }
            while(res == false);
        ...
        public void run() {
            while (true) {
                ...
                try {
                    ...
                    else if (userWord.startsWith("ban: ")&&isAdmin)
                    {
                        out.write(userWord + "\n");
                    }
                    else if (userWord.startsWith("ban: "))
                    {

...
Доп. задание
Добавить группы пользователей(все, коллеги, друзья, семья). Набор групп определен заранее и не расширяется. Пользователь может входить в несколько групп. Вверху страницы ссылки---все, коллеги, друзья, семья. При нажатии на ссылку---переход на страницу, где указаны только пользователи из соответствующей группы.
